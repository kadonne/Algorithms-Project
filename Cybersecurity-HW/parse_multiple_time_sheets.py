...
def parse(data_file, max_data_size):
    ...
    dictionary_data = dictionary_data + data[:dictionary_index]
    bst_data = bst_data + data[dictionary_index:bst_index]
    trie_data = trie_data + data[bst_index:]
...
bst_data = []
trie_data = []
parse(open("3k_time_sheets.txt", 'r'), '3000')
parse(open("parsing_time_sheets.txt",'r'), '10000')
parse(open("time_sheets.txt", 'r'), '5000')
